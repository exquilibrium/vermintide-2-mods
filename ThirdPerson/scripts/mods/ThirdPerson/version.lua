...
local OUR_VERSION_TIMESTAMP = 1788057915

-- The "last_build" checkbox's displayed label (see ThirdPerson_data.lua -
...
-- ThirdPerson_localization.lua - "_Version Mod.bat" stamps that entry's text
