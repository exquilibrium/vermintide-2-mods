...
local OUR_VERSION_TIMESTAMP = 1788048497

-- Shown in the mod options menu as the "last_build_group" widget's header
-- (see GiveWeaponPlus_data.lua - that widget has no sub_widgets, so this
-- header is all it displays). Local time, not UTC, since this is
-- player-facing and doesn't depend on the Steam check below succeeding.
