...
mod.create_test_entries = function (self)
	...
	self:register_entry("burninating", "Burning damage", "highest", self.returnstat, true)
	self:register_entry("bleed", "Bleed damage", "highest", self.returnstat, true)
	self:register_entry("poison", "Poison damage", "highest", self.returnstat, true)
